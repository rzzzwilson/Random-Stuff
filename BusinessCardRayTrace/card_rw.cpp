...
//i G[] = {0, 393411, 409319, 409307, 491715, 442563, 0, 0, 0};
i G[] = {0, 131138, 131174, 212570, 163906, 147522, 0, 0, 0};
...
v S (v o, v d)
{
  ...
  v h = o + d * t, l = !(v (9 + R (), 9 + R (), 16) + h * -1), r =
    d + n * (n % d * -2);
  f b = l % n;
  if (b < 0 || T (h, l, t, n))
    b = 0;
...
i main ()
{
  ...
  v g = !v
    (-6, -16, 0), a = !(v (0, 0, 1) ^ g) * .002, b = !(g ^ a) * .002, c =
    (a + b) * -256 + g;
  for (i y = 512; y--;)
    for (i x = 512; x--;)
      {
