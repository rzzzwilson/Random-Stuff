...
Graph.prototype.refresh = function(event)
{
    ...
    if (this.DamageCurve != null)
    {
        for (var i in this.DamageCurve.points)
        {
            ...
            this.canvas_ctx.beginPath();
            this.canvas_ctx.moveTo(screen_x, y_plus_delta);
            this.canvas_ctx.lineTo(screen_x, screen_y-screen_delta);
            this.canvas_ctx.moveTo(screen_x-graphEBCapWidth, y_plus_delta);
            this.canvas_ctx.lineTo(screen_x+graphEBCapWidth, y_plus_delta);
